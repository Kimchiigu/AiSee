...
from modules import dashboard, face_attendance, exam_supervisor, score_analysis, camera_feeds, access_control, incident_reports, settings
...
if not st.session_state.logged_in:
    ...
    page = st.sidebar.radio(
        "Navigation",
        ["Dashboard", "Face Attendance", "Exam Supervisor", "Score Analysis"]
    )
